      ...
      <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
        <div>
          ...
          <p>
            ...
            shipping address, and payment details when you place an order. We
            also collect usage data such as browsing patterns and device
        ...
        <div>
          ...
          <p>
            ...
            purchases, personalize your shopping experience, and send
            promotional content (with your consent). We never sell your personal
        ...
        <div>
          ...
          <p>
            ...
            encryption, secure payment processing through Stripe, and regular
        ...
        <div>
          ...
          <p>
            ...
            preferences, and analyze site traffic. You can manage cookie
        ...
        <div>
          ...
          <p>
            ...
            Contact us at privacy@omegacollections.com for any requests.
          </p>
        </div>
        <div>
          <h2 className="font-display text-lg font-bold text-foreground mb-3">
          ...
          <p>
            ...
            at privacy@omegacollections.com or write to: Omega Collections, 123
