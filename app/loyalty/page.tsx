  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Join Omega Rewards — earn points on every purchase and unlock exclusive tiers and benefits."
      />
      <NavbarWrapper />
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Earn points on every purchase and unlock exclusive perks as you
            climb tiers.
          </p>
        </motion.div>
        ...
        {isLoggedIn && (
          <motion.div
            ...
            className="max-w-xl mx-auto mb-12 p-6 bg-card border border-border rounded-xl text-center"
          >
            ...
            >
              ...
              <ul className="space-y-2">
                {tier.benefits.map((b) => (
                  ...
                  >
                    <Star size={12} className="text-copper mt-0.5 shrink-0" />{" "}
                    {b}
                  </li>
                ))}
              </ul>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Use your points for discounts and perks
          </p>
        </div>
