...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.7-3.1-11.3-7.7l-6.6 5.1C9.5 39.6 16.2 44 24 44z"/>
    <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.1 5.6l6.2 5.2C41.9 35.4 44 30.1 44 24c0-1.2-.1-2.4-.4-3.5z"/>
  </svg>
);
      ...
      <div className="flex items-center justify-center py-20 px-4">
        ...
        >
          <div className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground text-center mb-8">Join Omega Collections</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={submitting} className="btn-hero w-full disabled:opacity-60">
